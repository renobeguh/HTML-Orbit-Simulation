...
(function(){
 ...
 (function(){
	...
	//sats.push(new Sat({x:310, y:180, u:2, v:1, m:20, c:"#FF0000"}));
	sats.push(new Sat({x:315, y:500, u:-.5, v:0, m:10}));
	
	//sats.push(new Sat({x:310, y:400, u:-1.5, v:0, m:10, c:"#FFFF00"}));
